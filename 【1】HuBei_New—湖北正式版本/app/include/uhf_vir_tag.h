...
extern void vir_tag_procLinkOpend(int *ptRcvMsg);
extern void vir_tag_procPowerOn(int *ptRcvMsg);
extern void vir_tag_startCmd(T_Msg *ptRcvMsg);
...
extern void vir_tag_remove6cTagAll(int *ptMsg);
extern void vir_tag_remove6bTagAll(T_Msg *ptMsg);
extern void vir_tag_stopCmd(T_Msg *ptMsg);
extern void vir_tag_startLlrpCmd(T_Msg *ptMsg);
...
void vir_tag_procMsg(int *ptRcvMsg);
